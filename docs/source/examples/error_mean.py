...
# of a diatomic molecule {cite:p}`kratzer_1920_die,fues_1926_das` at constant temperature.
...
# See the [Error Estimates](../theory/properties/error_estimates.md) section for more details.
